...
All endpoints are prefixed with \`/api/v1\`.
    ...
    tags: [
      ...
      { name: 'UserSearch', description: 'User search operations' },
      { name: 'UserDetail', description: 'User profile and detail operations' },
      { name: 'UserRequest', description: 'User roles, team, and branch requests' },
      { name: 'GroupSearch', description: 'Group search operations' },
      { name: 'GroupDetail', description: 'Group detail and assignment operations' },
      { name: 'RoleSearch', description: 'Role search operations' },
      { name: 'RoleDetail', description: 'Role detail and permission resource mapping' },
      { name: 'Resource', description: 'Resource mapping and screens' },
      { name: 'CommonConfigurationSearch', description: 'Configuration search' },
      { name: 'CommonConfigurationDetail', description: 'Configuration details, regions, and branches' },
      { name: 'Message', description: 'System messaging endpoints' },
      { name: 'EmailCommunication', description: 'Email communication endpoints' },
      { name: 'Audit', description: 'Audit log search and details' },
      { name: 'Login', description: 'Authentication login operations' },
      { name: 'ResetPassword', description: 'Password reset operations' },
    ],
    components: {
      securitySchemes: {
        BearerAuth: {
