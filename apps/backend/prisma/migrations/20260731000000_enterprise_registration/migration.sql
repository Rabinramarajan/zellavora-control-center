-- Enterprise Registration Schema Migration
-- Extends Tenant → Organization with comprehensive registration fields

-- ============================================================================
-- RENAME: organizations table already exists, we'll add new columns
-- ============================================================================
...
-- ============================================================================
-- UPDATE USER_TENANT (organization_members) TABLE
-- ============================================================================
...
ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMPTZ,
ALTER COLUMN "address" TYPE VARCHAR; -- Ensure it's VARCHAR
...
-- Roles - add is_system field
ALTER TABLE "roles"
ADD COLUMN IF NOT EXISTS "name" VARCHAR,  -- Display name
