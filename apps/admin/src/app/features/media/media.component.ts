...
export class MediaComponent implements OnInit {
  ...
  typeOptions: SelectControlOption[] = [
  ...
  media: MediaFile[] = [
    ...
    {
      id: '2',
      name: 'zellavora-logo.png',
      type: 'image',
      size: 150000,
      uploadedDate: 'May 21, 2025',
      uploadedBy: 'Rabin R',
      category: 'General',
    },
    {
      id: '3',
      name: 'workspace-setup.webp',
      type: 'image',
      size: 1800000,
  ...
  filterMedia() {
    this.filteredMedia = this.media.filter((file) => {
      const matchesSearch =
        !this.searchTerm || file.name.toLowerCase().includes(this.searchTerm.toLowerCase());
